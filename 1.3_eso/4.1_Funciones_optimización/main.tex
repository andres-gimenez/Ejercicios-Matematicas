...
\begin{questions}
    ...
    \question 
        ...
        Sabiendo que el perímetro de la ventana es $6,6m$, hallar sus dimensiones para que la superficie sea máxima. 
    ...
    \question 
        ...
        El perímetro de la ventana mide $6m$. 
    ...
    \question 
    Entre todos los triángulos isósceles (dos lados iguales) de perímetro $30m$, ¿cuál es el de área máxima? 

    \question
    Una empresa vinícola tiene plantadas 1200 cepas de vid en una finca, produciendo cada cepa una media de 16kg de uva. 
    Según un estudio previo sabemos que, por cada cepa que se añade a la finca, las cepas producen de media 0,01 kg menos de uva cada una. Determínese el número de cepas que se deben añadir a las existentes para que la producción de uvas de la finca sea máxima.

    \question 
    Se desea construir un depósito con forma de prisma rectangular de base cuadrada y con una capacidad de $360 m^3$. 
    Los costes por $m^2$ son los siguientes: 40\euro{} para el fondo, 30\euro{} para las paredes laterales y 60\euro{} para el techo del depósito. 
    Calcula las dimensiones del depósito para que su coste sea el menor posible.

    \question 
    Un agricultor dispone de 3000 para cercar un terreno rectangular, 
    usando el río adyacente como lado con el fin de que el recinto sólo necesite 3 cercas. 
    El coste de la cerca paralela al río es de 5\euro{} por metro instalado, 
    y el de la cerca para cada uno de los lados restantes es de 3\euro{} por metro instalado. 
