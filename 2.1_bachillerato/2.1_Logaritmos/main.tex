...
\begin{equation*}
    \log_b (\dfrac {N}{M}) = \log_b (N)-\log_b (M)
\end{equation*}
...
\begin{questions}
    ...
    \question 
    La función que permite calcular en canto se convierte un capital $C_0$ acumulado al cabo de $t$ años es:
    \begin{equation*}
        C(t) = C_0 \cdot \left(1+\frac{i}{100}\right)^t
    \end{equation*}
    donde: $C_0$ es el capital inicial e $i$ el interés anual.
    \begin{parts}
    ...
    \end{equation*}
    donde: $M_0$ es el volumen inicial de madera, en $m^3$ e $I$ es el crecimiento anual, en \%.
    \begin{parts}
