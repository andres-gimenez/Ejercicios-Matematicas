...
Nueve trabajadores cargan un camión en 2 horas. ¿Cuánto tardan seis trabajadores?]
...
#question[Para empapelar un salón se necesitan 40 m de papel de 0,65 m de ancho. 
Si los rollos tuvieran un ancho de 0,55 m, ¿cuántos metros de papel pintado se necesitarían para empapelar el mismo salón?]
...
#question[Por hacer un trabajo tres obreros han cobrado 20.400 euros. 
        Uno trabajo 15 días, otros 12 días y el tercero 9 días. 
        ¿Cuánto le corresponderá a cada uno?]

#question[Victoria quiere repartir 315€ entre sus nietos Sara y Alfredo que tienen, respectivamente, 12 y 18 años, 
        de forma que el reparto sea proporcional a la edad. ¿Cuánto le dará a cada uno?]

#question[Reparte la cantidad de 4.500 de forma directamente proporcional a 2, 3, 4 y 9.]
        
#question[Un padre quiere repartir 1.200€ entre sus tres hijos Laura, Miguel y Carmen, en partes proporcionales a la edad de cada uno. 
        Laura tiene ahora 12 años, Miguel 16 y Carmen 20. ¿Cuánto recibirá cada uno?]
        
#question[Tres personas se asocian para empezar un negocio. 
        El socio A aporta un capital de 25.000€, el socio B uno de 20.000€ y el C aporta 35.000€.
        Al cabo de cierto tiempo se reparten un beneficio de 60.000€.
        ¿Cuánto le corresponde a cada uno?]

#question[Reparte el número 6 500 en partes proporcionales a 6, 9 y 11.]

#question[María nos dice: “Tengo 14 años y mi hermana Noelia 7. 
        Nuestros padres nos quieren repartir 300 € proporcionalmente a nuestros años. 
        ¿Cuánto nos darán a cada una?”]

#question[Los García-Martínez reparten 600€ entre sus tres hijos proporcionalmente a sus edades. 
La edad de los dos menores es de 2 y 5 años, respectivamente, y se sabe que el de 2 años obtiene 80€.
¿Cuál es la edad del hermano mayor y cuánto le correspondió a cada uno?]

#question[Sara y Antonio han ganado a la lotería 150.000€ correspondiéndole a Sara 80.000€ y a Antonio 70.000€.
Sabiendo que se gastaron 600 euros en lotería, ¿cuánto aportó cada uno para comprarla?]
    
#question[Dos empresas, A y B, aportaron para la fundación de otra empresa común, 10.000.000 de euros de la 
        siguiente forma: la empresa A aportó 6.000.000 de euros y la empresa B aportó el resto. Al cabo de un 
        año, la nueva empresa ha obtenido un beneficio de 1.000.000 de euros. ¿Qué capital corresponde a la 
        empresa A? ¿Y a la B?]

#question[Un padre le da la paga a sus tres hijas de forma que a cada una le corresponde una cantidad proporcional a su edad.
A la mayor, que tiene 20 años, le da 50 euros. 
¿Cuánto dará a las otras dos hijas de 15 y 8 años de edad?]

#question[Tres amigos han comprado un décimo de lotería de Navidad. 
Juan ha aportado 5 €, Luis ha aportado 12 € y Eva ha aportado el resto que les faltaba hasta los 20 € que vale el décimo. 
Si les toca un premio de 30 000 € y deciden repartirlo proporcionalmente al dinero que puso cada uno, ¿cuánto deben recibir?]

#question[Por un reportaje fotográfico tres fotógrafos cobraron 6720 euros. 
Del reportaje, 14 fotos eran del primer fotógrafo, 18 del segundo y 24 del tercero. 
¿Qué cantidad de euros le corresponde a cada uno?]
