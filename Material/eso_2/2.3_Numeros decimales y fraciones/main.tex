...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand{\documentName} { Números decimales }
\renewcommand{\documentContent} { Decimales y fracciones } 
...
\begin{questions}
    ...
    \begin{minipage}{\linewidth} 
        \begin{wrapfigure}{r}{5cm}
            \vspace{-0.2cm} 
            \includegraphics[width=5cm]{Rhind_Mathematical_Papyrus}
            \captionsetup{labelformat=empty}
            \caption{\footnotesize {Papiro de Ahmes o papiro Rhind}}
        \end{wrapfigure}
        \question El papiro de Ahmes, es un texto redactado en escritura hierática, 
        fechado en el siglo XVI a.C copia de un texto de trescientos años de antigüedad, según el propio escriba Ahmes cuenta al principio del texto.
        Se trata de un texto con 87 problemas matemáticos, en el que se puede ver en el problema 50 como calcular el área del círculo, 
        haciendo una aproximacío del número $\pi$ a:

        \begin{equation*}
        \pi \approx 3 + \frac{1}{9} + \frac{1}{27} + \frac{1}{81}
        \end{equation*}

        \begin{parts}
            \part Calcula la aproximación egipcia en números decimales.
            \part Es un número decimal periódico, ¿Cuál es el periodo?
            \part Otra forma de expresar esta aproximación es 
            \begin{equation*}
                \pi \approx 3 + \frac{1}{7} + \frac{1}{57} + \frac{1}{10773}
            \end{equation*}
            ¿Es el mismo número?
        \end{parts}
