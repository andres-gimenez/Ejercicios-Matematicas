...
#questions-pages(
    ...
    #questions-columns(
      ...
      [#subquestion()[Formen un ángulo de 60º.]
        #solution()[
          ...
          $display(
            (abs(8 + m))/(sqrt(14) dot sqrt(5 + m^2)) = 1/2 => abs(8 + m) = (sqrt(14) dot sqrt(5 + m^2))/2 =>
  ...
  [
    ...
    #questions-columns(
      ...
      [
        #subquestion()[Sobre la recta $display(
            r equiv cases(
              delim: "{",
              3x + 4y = 8,
              x +4z = -20
  ...
  [
    ...
    #questions-columns(
      ...
      [#subquestion()[Respecto a la recta $display(
            r equiv cases(
              delim: "{",
              24x-36y=-7,
              2z = 1
  ...
  [
    #question()[Halla la recta simétrica de $display(
        r equiv cases(
          delim: "{",
          x = 2 + lambda,
          y= -2 + lambda,
  ...
  [
    #question()[Comprueba que las rectas $r$ y $s$ se cruzan y calcula la distancia entre ellas.
      ...
      $
        r equiv (x-1)/2= (y-1)/(-1) = (z-1)/1 ";  " s equiv cases(
          delim: "{",
          2x + 3y + z = -2,
          x+y=0,
        )
