...
#questions-pages(
  ...
  [
    ...
    #questions-columns(
      ...
      [#subquestion()[$display(mat(&1, -&2, " "&0, -&3; -&1, &3, &1, &4; &2, &1, &5, -&1))$]
        #solution()[
          $display(
            "rango"mat(&1, -&2, " "&0, -&3; -&1, &3, &1, &4; &2, &1, &5, -&1) =
      ...
      [#subquestion()[$display(mat(&1, " "&0, &2, " "&1, -&1; &0, &2, -&1, &1, &2; -&1, &1, &3, &2, &0; &0, &8, &7, &9, &4))$]
        #solution()[
          ...
          $display(
            "rango"mat(&1, " "&0, &2, " "&1, -&1; &0, &2, -&1, &1, &2; -&1, &1, &3, &2, &0; &0, &8, &7, &9, &4)
  ...
  [
    ...
    #solution()[
      ...
      $display(X = (2 I - A^t) A^(-1) = mat(&1, &1; &0, &3) dot mat(&1, &0; -&1, -&1) = mat(&0, -&1; -&3, -&3))$
    ]
  ],
  // [
