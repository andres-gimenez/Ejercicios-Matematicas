  ...
  [
    ...
    #questions-columns(
      ...
      [
        ...
        #solution()[
          $display(
            limits("lím")_(x -> 1^-) sqrt(x^2 + 2x - 3)
  ...
  [
    ...
    #questions-columns(
      [
        ...
        #solution[
          $display(
            limits("lím")_(x->a) [2f(x) - 2g(x) + h(x)] = limits("lím")_(x->a) 2f(x) - limits("lím")_(x->a) 2g(x) + limits("lím")_(x->a) h(x)
            = 2 limits("lím")_(x->a) f(x) - 2 limits("lím")_(x->a) g(x) + limits("lím")_(x->a) h(x) = \
            = 2 dot (-2) - 2 dot 2 +5 = (-4) dot (-4) + 5
          ) = result(-3)$
        ]
      ],
      [
  ...
  [
    ...
    #questions-columns(
      ...
      [
        ...
        #solution()[
          $display(
            limits("lím")_(x->4) (x^2+x-20)/(x^2-7x+12)
      ...
      [
        ...
        #solution()[
          $display(
            limits("lím")_(x->3) (x^2-x-6)/(x^2+4x-21) = 0/0 "(indeterminado)" \
            limits("lím")_(x->3) (x^2-x-6)/(x^2+4x-21) = limits("lím")_(x->3) ((x + 2) cancel((x - 3)))/((x + 7) cancel((x - 3))) = limits("lím")_(x->3) (x + 2)/(x + 7) = (3+2)/(3+7) = 5/10 = 1/2
          )$ // #rect[$display(1/2)$] )
        ]
      ],
      [
        ...
        #solution()[
          $display(
            limits("lím")_(x->1) (x^4-x^3-3x^2+5x-2)/(x^2-2x+1) = 0/0 "(indeterminado)" \
