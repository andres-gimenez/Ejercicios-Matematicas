    ...
    #questions-columns(
      [
        ...
        #solution()[
          ...
          $display(
            P(A inter overline(B)) = P(A) - P(A inter B) => \
      ...
      [
        ...
        #solution()[
          $display(
            P(A|B) - P(B|A) = (P(A inter B))/(P(B)) - (P(A inter B))/(P(A)) => \
      ...
      [
        ...
        #solution()[
          ...
          $display(
            P(A union C) = P(A) + P(C) - P(A inter C) = P(A) + P(C) - P(A) dot P(C) => \
