    ...
    #questions-columns(
      ...
      [#subquestion()[Al menos haya uno defectuoso.]
        #solution()[
          ...
          $display(
            P(X ≥ 1) = 1 - P(X = 0) = 1 - binom(6, 0) ("0,1")^0 (1-"0,1")^6 = 1 - binom(6, 0) dot (0,1)^0 dot (0,9)^6 = \ =
            1 - "0,531441" = "0,468559"
          )$]
      ],
    )
    ...
    #questions-columns(
      ...
      [#subquestion()[La probabilidad de que la aprueben exactamente 4.]
        #solution()[
          ...
          $display(
            P(X = 4) = binom(8, 4) ("0,35")^4 (1-"0,35")^4 =70 dot ("0,35")^4 dot ("0,65")^4 = \ =
    ...
    #questions-columns(
      [#subquestion()[Calcula la probabilidad de que al menos dos artículos sean defectuosos.]
        #solution()[
          ...
          $display(
            P(X = 1) = binom(15, 1) ("0,02")^1 (1-"0,02")^14 =binom(15, 1) dot ("0,02")^1 dot ("0,98")^14 = \ =
    ...
    #questions-columns(
      ...
      [#subquestion()[$Z ~ N(0, 1)$, $P(-2 < Z < 1, 92)$]
        #solution()[
          ...
          $display(
            P(-2 < Z < 1,92) = Phi(1, 92) - Phi(-2) = Phi(1, 92) - (1 - Phi(2)) = \ =
      ...
      [#subquestion()[$Z ~ N(0, 1)$, $P(-0, 24 ≤ Z < 2, 71)$]
        #solution()[
          ...
          $display(
            P(-0,24 ≤ Z < 2,71) = Phi(2, 71) - Phi(-0, 24) = Phi(2, 71) - (1 - Phi(0, 24)) = \ =
    ...
    #questions-columns(
      ...
      [#subquestion()[$X ~ N(176, 15)$, $P(170 < X < 180)$]
        #solution()[
          ...
          $display(
            P(170 < X < 180) = P ((170- 176)/(15) < Z < (180- 176)/(15)) = P(-0,4 < Z < 0,27) = \ =
    ...
    #questions-columns(
      ...
      [#subquestion()[Entre 10 y 11 años.]
        #solution()[
          ...
          $display(
            P(10 < X < 11) = P ((10- 10)/(2) < Z < (11- 10)/(2)) = P(0 < Z < 0,5) = \ =
