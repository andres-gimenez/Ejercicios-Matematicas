...
= Definición de logaritmo
  ...
  Si *$b$* es un número positivo y distinto de 1, el *logaritmo en base a de un número positivo N*
...
2. El logaritmo de 1 es siempre igual a 0, independiente mente de la base.
  $ log_n 1 = 0 $

3.El logaritmo del producto es igual a la suma de los logaritmos:
