...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand{\documentName} { Porcentajes }
\renewcommand{\documentContent} { Problemas con porcentajes } 
...
\begin{questions}
    \question Tres rr jinetes disputan una carrera invirtiendo para ello $\frac{7}{5}$ de hora, $\frac{20}{12}$ horas y $\frac{16}{9}$ horas, respectivamente.
