\documentclass[addpoints,spanish, 12pt,a4paper,cancelspace]{./include/gexercises}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand{\documentName} { Matemáticas financieras }
\renewcommand{\documentContent} { \phantom{ Propiedades y ejercicios} } 
...
\begin{center}
    \fbox{\parbox{6.5in}{
        \vspace{3mm}
            {\Large
                % \centerline{
                    \textbf{Índice de variación}
                    % }
            }
        \vspace{5mm}

    El índice de variación, $iv$, es el factor multiplicativo que se aplica a la cantidad inicial, $C_i$, 
    ...
    \vspace{2mm}
    \begin{equation*}
        C_f = iv \cdot C_i \Rightarrow iv = \frac{C_f}{C_i}
    \end{equation*}
...
%     \begin{parts}
%         \part ¿Cuanto valdrá dentro de un año? ¿Y dentro de 3 años?
