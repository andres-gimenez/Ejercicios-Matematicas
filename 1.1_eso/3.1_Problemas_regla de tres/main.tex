...
\newcommand{\documentContent} { Problemas regla de tres } 
\newcommand{\waterMark} {  } 
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{questions}
    ...
    \question Una moto recorre 30 km en 15 minutos. ¿Cuántos kilómetros recorrerá en 2 horas? ¿Y cuánto tardará
    en recorrer 50 km?
    ...
    \question Si una máquina embotelladora llena 240 botellas en 20 min, ¿cuántas botellas llena en hora y media? 
    ...
    \question  {
        \penalty-5000
        Una receta de tarta de manzana nos especifica los siguientes ingredientes para 6 personas: 
        \begin{itemize}
            \item 365 g. de harina 
            \item 4 huevos 
            \item 300 g. de mantequilla 
            \item 250 g. de azúcar 
            \item 6 manzanas. 
        \end{itemize}
    ...
    \question {
        ...
        \begin{enumerate}[label=\roman*)]
            \item Cantidad de personas que viajan en un autobús y dinero recaudado. 
            \item Cantidad de refrescos que caben en una caja y diámetro de las botellas. 
            \item Número de litros que escapan por segundo en el desagüe de una piscina y diámetro del desagüe. 
            \item Velocidad media de un ciclista y distancia recorrida. 
            \item Número de vueltas que da una rueda para recorrer una distancia y diámetro de la rueda. 
            \item Número de comensales para zamparse una tarta y cantidad que come cada uno. 
            \item Tiempo que tarda un balón en caer al suelo y altura desde la que se lanza. 
            \item Número de horas que está encendida una bombilla y gasto que ocasiona. 
            \item Número de peldaños de una escalera de altura fija y anchura de ellos. 
            \item Número de goles marcados por un equipo y partidos ganados. 
            \item El número de libros que caben en una estantería y el grosor de estos.
            \item La velocidad a la que corre una moto y el tiempo que tarda en hacer un determinado trayecto.
            \item El número de litros de agua y el número de botellas que los contienen.
            \item El número de sandías que hay en un camión y el peso de éste.
            \item El número de cromos que reparto entre mis amigos y el número de amigos.
            \item El número de personas en un campamento y el número de raciones de comida.
            \item El número de líneas de cada página y el número de páginas de una novela.
            \item Número de horas dedicadas a las matemáticas y nota de mi examen.
            \item Peso y estatura de una persona.
        \end{enumerate}
    }

    \question Por hacer un trabajo tres obreros han cobrado 20.400 euros. 
        Uno trabajo 15 días, otro 12 días y el tercero 9 días. 
        ¿Cuánto le corresponderá a cada uno? 

    \question Victoria quiere repartir 315\euro{} entre sus nietos Sara y Alfredo que tienen, respectivamente, 12 y 18 años, 
    ...
    \question Un padre quiere repartir 1.200\euro{} entre sus tres hijos Laura, Miguel y Carmen, en partes proporcionales a la edad de cada uno. 
    ...
    \question Tres personas se asocian para empezar un negocio. 
        El socio A aporta un capital de 25.000\euro{}, el socio B uno de 20.000 \euro{} y el C aporta 35.000 \euro{}.
        Al cabo de cierto tiempo se reparten un beneficio de 60.000 \euro{}.
    ...
    \question María nos dice: “Tengo 14 años y mi hermana Noelia 7. 
        Nuestros padres nos quieren repartir 300 \euro{} proporcionalmente a nuestros años. 
        ¿Cuánto nos darán a cada una?”

    \question Los García-Martínez reparten 600\euro{} entre sus tres hijos proporcionalmente a sus edades. La edad de los 
        dos menores es de 2 y 5 años, respectivamente, y se sabe que el de 2 años obtiene 80\euro{}. ¿Cuál es la 
        edad del hermano mayor y cuánto le correspondió a cada uno?

    \question Sara y Antonio han ganado a la lotería 150.000\euro{} correspondiéndole a Sara 80.000\euro{} y a Antonio 70.000\euro{}.
