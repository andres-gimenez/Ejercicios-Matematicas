...
#columns(2, [
  ...
  #subquestion()[$display(limits("lím")_(x->+infinity) ((cos(x))/(cos(x) + cos^2(x)))^cos(2x))$]
...
#columns(2, [
  ...
  #subquestion()[$display(limits("lím")_(x->+infinity) sqrt(x^7-2x+5) - sqrt(x^2+x+5))$]
...
#question()[Determina el valor de los siguientes límites:]
#columns(2, [
  #subquestion()[$display(limits("lím")_(x->infinity) x e^(-x))$]
