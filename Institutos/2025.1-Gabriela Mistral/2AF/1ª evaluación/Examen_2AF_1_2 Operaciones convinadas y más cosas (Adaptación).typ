...
#subquestion(points: 0.5)[$display(2/7 dot 7/3 + 2/11 dot 11/3 + 7/9 dot 9/3 - 2/5 dot 5/3)=$]
#v(1fr)

#question()[Resuelve las siguientes operaciones combinadas, indicando todos los pasos:]
#subquestion(points:1)[$display(5-2dot[4 + 7 dot (2-7) )])=$]
#v(1fr)

#subquestion(points:1)[$display((7-2)^2 + (2+7)^2 + (5-2)^2)=$]
#v(1fr)
...
#question()[Sin calcular el resultado final, expresa las siguientes expresiones como una sola potencia o una sola raíz:]
#subquestion(points:0.5)[$display(345^3 dot 345^9 =)$]
#v(1fr)
// #subquestion(points:0.5)[$display(35^5 dot 4^5 =)$]
// #v(1fr)

#subquestion(points:0.5)[$display(sqrt(8) dot sqrt(2) =)$]
#v(1fr)
