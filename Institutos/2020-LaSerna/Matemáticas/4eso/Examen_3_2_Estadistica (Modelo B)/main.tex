...
\begin{document}
	...
	\begin{questions}
		...
		\begin{table}[h!]
			...
			\hline
			\cellcolor[gray]{0.8}$f_i$ & 5 & 7 & 11 & 15 & 17 & 6 & 3 \\
			\hline
			\end{tabular}
		\end{table} 
        \\
        ...
        En una fábrica de bombillas se estudia la vida de un tipo de bombilla. Se ha tomado una muestra de 200 lámparas con los siguientes resultados:
            \begin{table}[h!]
                ...
                \hline
                \cellcolor[gray]{0.8}Nº bombillas & 12 & 45 & 70 & 45 & 10 \\
                \hline
                \end{tabular}
            \end{table} 
        ...
        \begin{table}[h!]
			...
			\hline
			\cellcolor[gray]{0.8}Nº árboles & 6 & 12 & 16 & 7 \\
			\hline
			\end{tabular}
		\end{table} 
        \\
        \begin{parts}
            \part 
                ...
                \vspace{\stretch{1}}
            \part 
                % varianza = 3,51 y Desviación típica = 1,87.
