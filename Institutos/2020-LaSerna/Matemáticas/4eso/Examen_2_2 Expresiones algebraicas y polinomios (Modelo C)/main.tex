...
\begin{document}
	...
	\begin{questions}
        ...
        \question[1]
        Si $P(x)=x^4 + x^3 + 2x^2 - 2x + 5$, evalúa.
        \begin{parts}
            \part
                $P\left(-1\right)$
                \vspace{\stretch{1}}
        ...
        \question[2]
        Sea $P(x)=x^5+5x^3-2x+2$, $Q(x)=3x^4-3x^2+2x+1$, $R(x)=x^2 -2x +3$ calcula.
        \begin{parts}
            \part
                $P(x) - Q(X)$
                \vspace{\stretch{3}}
        ...
        \begin{minipage}{\linewidth}
            \centering
            \includegraphics[width=12cm]{Plano04}
        \end{minipage}
        \begin{parts}
            \part
            Halla el polinomio que nos permita calcular el área del porche en función del tamaño de este.
            \part
            Si se ha comprado $15m^2$ de baldosas para solar el porche, ¿cuántos metros cuadrados de jardín nos quedan? 
        \end{parts}
	\end{questions}
\end{document}