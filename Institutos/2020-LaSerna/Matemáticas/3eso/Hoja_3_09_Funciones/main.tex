...
\begin{questions}
    ...
    % \begin{parts}
    %     \part
    %     Indica si es continua, de no ser así ¿Cuales son los puntos de discontinuidad y cuanto vale la función en dichos puntos?
    %     \part
    %     Indica los intervalos de crecimiento y decrecimiento.
    %     \part
    %     Indica cuales son los máximos y los mínimos y si son relativos y absolutos.
    ...
    \begin{parts}
        ...
        \part
        ¿Cuantos metros ha recorrido en 5s?
        \part
