%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\documentName} { Examen Pendientes 1º}
...
\begin{questions}
    ...
    \begin{parts}
        ...
        \PartNoBreak{
            Los conectores de los cables de par trenzados utilizados por Ethernet se denominan \dots
            \newline
            \begin{oneparcheckboxes}
                \choice 
                    RJ-11
        ...
        % \PartNoBreak {
        %     \dots Cuando un equipo tiene un problema de acceso a la red, recomienda hacer las comprobaciones en el orden \dots
        %     \newline
        %     \begin{oneparcheckboxes}
        %         \choice 
    ...
    \begin{parts}
        ...
        \part
        IP: 2001:235:43::325a / 64 
        \begin{solution}[0cm]
            Red: 2001:235:43:: / 64 \\
            Rango de hosts:  2001:235:43::1 \\ - 2001:235:43::ffff:ffff:ffff:ffff \\
        \end{solution}
        \vspace{\stretch{2}}
    ...
    \begin{parts}
        ...
        \part
        IP1: 2001:233:da22:a3ds:4d49:d2ee:9b7a:569c / 64 \\
        IP2: 2001:233:da22:a3ds:44d1:92c6:d35c:7f6d / 64 \\
        \begin{solution}[0cm]
            Son válidas y perteneces a redes distintas.
        \end{solution}
        ...
        \vspace{\stretch{1}}
        \part
        IP1: 2001:233:da22:a3ds:4d49:d2ee:9b7a:569c / 56 \\
        IP2: 2001:233:da22:56af:44d1:92c6:d35c:7f6d / 56 \\
        \begin{solution}[0cm]
            Son válidas y perteneces a redes distintas.
        \end{solution}
        \vspace{\stretch{1}}
