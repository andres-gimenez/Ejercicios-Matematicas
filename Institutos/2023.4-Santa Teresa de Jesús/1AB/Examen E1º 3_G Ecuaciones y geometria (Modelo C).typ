...
#g-question(point:2)[Que altura ha de tener un trapezoide, cuyas bases miden $6 "cm"$ y $4 "cm"$, para que su área mida $"15 cm"^2$.] \ 
...
#g-subquestion(point:1)[$display(8x+5=17-4x)$]
#v(2fr)

#g-subquestion(point:1)[$display(3(2+2x) = 10)$]
#v(3fr)