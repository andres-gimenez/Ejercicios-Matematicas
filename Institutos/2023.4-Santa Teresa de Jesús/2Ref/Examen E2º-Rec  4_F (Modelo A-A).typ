...
#g-question(point:3)[Simplifica las siguientes expresiones algebraicas:]
...
#g-subquestion(point:2)[$display(2 (5x + 2) = 4x + 3)$]
#v(1fr)
...
#g-question(point:3)[Una granja acaba de vender 35 jamones a 18€ el kilo, obteniendo 7.560€. ¿cuántos pesan todos los jamonos? ¿Y cuánto pesa cada jamón?]
#v(1fr)