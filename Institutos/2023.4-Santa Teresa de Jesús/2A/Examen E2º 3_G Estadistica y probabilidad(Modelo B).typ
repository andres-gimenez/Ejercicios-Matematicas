...
#g-subquestion(point: 1)[Sea verde]
#v(1fr)
...
#g-question(point:2)[Si los sucesos A y B son incompatibles y sabemos que $display(P(A)=3/5)$ y $display(P(B)=1/3)$. Calcula $display(P(A cal(union) B))$.]