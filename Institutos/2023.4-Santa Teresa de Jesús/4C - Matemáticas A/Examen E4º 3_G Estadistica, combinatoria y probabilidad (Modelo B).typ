...
#g-question(point: 2)[Se sabe que: $display(P(A)=3/4)$, $display(P(B)=3/5)$ y $display(P(A cal(union) B) = 7/8)$. Calcula $P(A cal(sect) B )$. ]
#v(1fr)

#g-question(point: 1)[Un jugador de baloncesto durante el partido ha lanzado 18 tiros libres y ha anotado 15. Si en el último minuto, va a lanzar un tiro libre, ¿cuál es la probabilidad de que lo falle?]
#v(1fr)
#pagebreak()

#g-question[Si estás en una clase de 24 alumnos]
...
#g-subquestion(point: 1)[Sea verdes]
#v(1fr)
#g-subquestion(point: 1)[No sea verdes]
#v(1fr)
#pagebreak()
