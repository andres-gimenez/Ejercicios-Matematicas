...
#subquestion()[$(5/4 + 7/4) dot (72/4 - 2 / 4)=$]
#v(1fr)
...
#v(1fr)
#subquestion()[$display(16/6)$ #h(1cm) $display(17/25)$]
#v(1fr)
...
#subquestion()[Si había 12 caramelos, ¿cuántos recibió María?]
#v(1fr)
...
#pagebreak()
#question(points:1)[Calcula la media de los siguientes valores y haz una tabla para organizar los datos.]
