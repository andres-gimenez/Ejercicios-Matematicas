...
#question(points:1)[Resuelve las siguientes ecuaciones:]
  #subquestion()[$x-5=2x-9$] //(sol: x=)
  #v(1fr)
  #subquestion()[$x+6=8-5x + 2$] //(sol: x=)
  #v(1fr)
  #subquestion()[$x+9=4 - 1/2 x$] //(sol: x=)
  #v(1fr)

#question(points:2)[Resuelve las siguientes ecuaciones:]
  #v(0.2cm)
  $display((3x)/5 + 1/3 = 3/2- (2- 2x)/3)$
  #v(2fr)
