...
#question()[Ana quiere construir un jardín en forma de triángulo. Sus lados miden 6 m, 8 m y 10 m.]

#subquestion()[Demuestra que el triángulo es rectángulo.]

#subquestion()[Calcula el área del jardín.]

#subquestion()[¿Cuánto mide el perímetro del jardín?]
...
#question()[Imagina que un parque tiene la forma de un paralelogramo. La base del paralelogramo mide 10 metros, y su altura (la distancia perpendicular entre las bases) es de 6 metros. Además, los lados inclinados miden 8 metros cada uno.]
...
#cetz.canvas({
  import cetz.draw: *
    ...
    line((0,0), (10, 0), (8, 6), (2, 6), close: true, fill: green)
    
    line((2, 0), (2, 6), stroke: (thickness: 1pt, dash: "dashed"))
