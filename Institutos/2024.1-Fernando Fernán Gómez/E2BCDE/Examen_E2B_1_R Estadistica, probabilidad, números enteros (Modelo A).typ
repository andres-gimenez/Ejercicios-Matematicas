...
#question(points:1)[En una promoción de una marca de refrescos, 
...
#question(points:1)[Tenemos que preparar un evento y hay que decidir si lo preparamos al aire libre o en interior. Al mirar la probabilidad de que llueva el día del evento, nos dicen que hay una probabilidad de 0,4 de que lo haga. ¿Qué probabilidad hay de que no llueva el día del evento? ]
#v(1fr)
