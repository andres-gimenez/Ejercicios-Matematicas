...
#subquestion[$display((-5)^3 dot (-5)^5)$ = ]
#v(1fr)

#subquestion[$display((-60)^7 dot (-60)^4)$ = ]
#v(1fr)

#subquestion[$display((-5)^8 dot (+6)^8)$ = ]
#v(1fr)

#subquestion[$display([(-15)^8]^3)$ = ]
#v(1fr)
...
#subquestion[$display(sqrt(14) dot sqrt(10) dot  sqrt(35))$ = ]
#v(1fr)
