...
\begin{questions}
    ...
    \question[2] Calcula el área de un triángulo equilátero de 8 cm de lado.

    \newpage

     % \question[2] El la Vuelta Ciclista a España, es un clásico la subida al alto de Navacerrada, 
    % la cual, en la vertiente segoviana por carretera tiene una longitud de $13,58km$, 
    % con un desnivel de $669m$. Calcula la pendiente media de dicha subida.

    \question[3] Calcula la ecuación de la recta paralela a $2x - y - 2 = 0$ y que pase por el punto $P(1,3)$.
    ...
    \question[3] Calcula el volumen del tronco de pirámide que tiene de dimensiones, 
        lado de la base mayor $10cm$, lado de la base menos $4cm$ y altura $6cm$.
        \\ \\
