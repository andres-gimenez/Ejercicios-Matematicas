...
\begin{questions}
    ...
    \question[5] Se quiere pintar un campo de baloncesto con la siguientes colores. 
    ...
    \newpage{}
    \question[5] Calcula la longitud de las líneas de un campo de futbol según el siguiente plano y cotas:
    \\ \\
    \begin{minipage}{\linewidth}
        \centering
