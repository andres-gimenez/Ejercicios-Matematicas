 ...
 \begin{questions}
    ...
    \par
    $\left(1+\frac{1}{3}-\frac{9}{7}\right) + \left(\frac{5}{3}-\frac{4}{5}\right):\frac{6}{12}$
    \vspace{\stretch{1}}
    ...
    \begin {parts}
        \part
        Entre tres hermanos deben repartirse 130 \euro{}. 
        El primero se lleva $\sfrac{2}{4}$ del total, el segundo $\sfrac{3}{4}$ del total y el tercero el resto. 
        ¿Qué fracción del total se lleva el 3º? 
        ¿Cuánto dinero se ha llevado cada uno?
        \vspace{\stretch{1}}
        
        \part
        La población de una pequeña ciudad según antiguo censo era de 26.268 habitantes. 
        Se ha realizado un nuevo censo y los datos informan de un incremento del $7\%$.
        ¿Cuál es la población actual?  
        \vspace{\stretch{1}}

        \part
        Cinco amigos que van de excursión y gastan 560\euro{} en 7 días. ¿Cuánto gastarán 7 personas en 11 días? 
        \vspace{\stretch{1}}

        % \part
        % Tres estudiantes participan en un concurso para repartirse el premio de 1.240\euro{} de forma inversamente proporcional al número de errores cometidos.
        % El primero alumno cometió 7 errores, el segundo 4 errores y el tercero 5 errores. 
        % ¿Cuánto recibirá cada uno? 
        % \vspace{\stretch{1}}

        \part
        Tres hermanos ayudan a su familia entregando 5.900\euro{}.
        Si sus edades son de 20, 24 y 32 años y las aportaciones son inversamente proporcionales a la edad,
