...
\begin{questions}
    ...
    \question[2]
    Dos trenes circula por una misma vía. Sus velocidades son de 200km/h y de 150 km/h. 
    Si les separan 780 km. ¿Cuánto tardarán en encontrarse?
    \vspace{\stretch{1}}

    \question[2]
    En una granja entre corderos y pollos hay 120 animales. 
    Si las patas de todos ellos suman 450. ¿Cuántos corderos y cuantos pollos hay?
    \vspace{\stretch{1}}
