...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand{\documentName} { Examen recuperación 2ª evaluación }
\renewcommand{\documentContent} { Ecuaciones, sistemas de ecuaciones y funciones } 
...
\begin{questions}
    ...
    \begin{tikzpicture}[scale=1]
        \begin{axis}[
            ...
            \addplot[domain=-15:-10,black] {x+10};
            \addplot[domain=-5:0,black] {x*x+6*x};
            \addplot[domain=0:5,black] {x};
            \addplot[domain=5:9,black] {x*x-15*x+55};
            
            % \addplot[domain=6:15,black] {-5};
            % \draw[dashed] (axis cs:6,6) -- (axis cs:6,-5);
            \addplot[holdotBlack] coordinates{(-15,-5)(-5,-5)(9,1)};
