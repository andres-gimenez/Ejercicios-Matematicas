...
% \end{center}
 ...
 \begin{questions}
    ...
    \begin {parts}
        ...
        \part[2] ¿Cuántas cerillas tiene la figura que se encuentra en la posición 120?
        \vspace{\stretch{1}}
    ...
    \begin {parts} 
        ...
        \vspace{\stretch{1}}
        \part[2] Indica en que posición se encuentra la figura que tiene 100 cuadrados rojos.
        \vspace{\stretch{1}}
    \end {parts}
