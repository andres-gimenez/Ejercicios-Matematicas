 %%%%%%%%%%%%%%%%%%%%%%%%%%%
 \newcommand{\documentName} { 3ª evaluación }
 \newcommand{\documentContent} { Regla de tres y porcentajes } 
...
\end{center}
 ...
 \begin{questions}
    ...
    \question[2] En un escaparate vemos unas zapatillas que cuestan 62\euro{} más 21\% de IVA con un descuento del 20\%. 
    ...
    \question[1] El 15\% de los alumnos de secundaria practican el baloncesto y el 37\% 
