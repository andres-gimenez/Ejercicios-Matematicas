...
\end{center}
 ...
 \begin{questions}
    ...
    \question[1] Manuel compra 3 kg de manzanas a 1,15\euro{} el kg y paga con un billete de 10 €.
    \begin {parts}
    ...
    \question[2] Realiza las siguientes operaciones con fracciones, simplificando el resultado al máximo:
        \begin {parts}
            \part $\frac{5}{3} + \frac{3}{4} + \frac{2}{9}$
            \vspace{\stretch{2}}
            
            \part $1 - \frac{1}{4} \cdot \frac{2}{3}$
            \vspace{\stretch{2}}

            \part $\frac{2}{5}: \frac{3}{7}$
            \vspace{\stretch{2}}
        \end{parts} 
    ...
    \question[0\half] Ordena de menor a mayor los siguientes números: 
        \\
        $7,05$ \phantom{1234} $7,101$ \phantom{1234} $7,11$ \phantom{1234} $7,005$ \phantom{1234} $7,1$ \phantom{1234} $7$
        \vspace{\stretch{1}}
