...
\end{center}
 ...
 \begin{questions}
    ...
    \question[2] Realiza las siguientes operaciones con fracciones, simplificando el resultado al máximo:
        \begin {parts}
            \part $\frac{7}{3} + \frac{1}{4} + \frac{5}{9}$
            \vspace{\stretch{2}}
            
            \part $1 - \frac{1}{3} \cdot \frac{2}{5}$
            \vspace{\stretch{2}}

            \part $\frac{2}{3} : \frac{5}{7}$
            \vspace{\stretch{2}}
        \end{parts} 

    \question[2]Realiza las siguientes operaciones con fracciones, simplificando el resultado al máximo:
        \begin {parts}
            \part $\left(\frac{5}{3} - \frac{1}{4}\right) : \left(1 - \frac{2}{3}\right)$
            \vspace{\stretch{3}}
    ...
    \question[1] Manuel compra 3 kg de peras a 2,65\euro{} el kg y paga con un billete de 20 €.
    \begin {parts}
    ...
    \question[1] Un obrero gana 390 \euro{} a la semana. 
    ¿Cuánto gana en 52 días?
    \vspace{\stretch{1}}
    ...
    \\
    $3,05$ \phantom{1234} $3,101$ \phantom{1234} $3,11$ \phantom{1234} $3,005$ \phantom{1234} $3,1$ \phantom{1234} $3$
    \vspace{\stretch{1}}
    
    \question[0\half] Obtén dos números decimales que estén comprendidos entre 5,6 y 5,7, uno que tenga dos decimales y otro que tenga tres.
    \vspace{\stretch{1}}
