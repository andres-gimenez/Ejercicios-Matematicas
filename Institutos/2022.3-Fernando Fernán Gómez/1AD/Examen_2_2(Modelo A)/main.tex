 ...
 \begin{questions}
    ...
    \begin {parts}
        \part Kg de pintura con metros cuadrados que podemos pintar con ella.
        ...
        \part Nota obtenido en el examen de matemáticas con el precio del bocadillo de lomo en la cafetería del instituto.
        \part Velocidad de un automóvil y tiempo en llegar a su destino.
    \end{parts}

    \question[1] El precio de 12 fotocopias es de 0,50\euro{}. ¿Cuánto costará hacer 30 fotocopias?
    \vspace{\stretch{1}}
    
    \question[1] Diez barras de pan cuestan 4,75 €. ¿Cuánto costarán 18 barras? ¿Y 24 barras? 
    \vspace{\stretch{1}}
