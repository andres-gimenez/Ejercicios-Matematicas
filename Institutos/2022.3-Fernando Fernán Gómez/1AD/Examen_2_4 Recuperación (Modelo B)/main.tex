...
\end{center}
 ...
 \begin{questions}
    ...
    % \question[1]
    % \begin {parts}
    %     \part Realiza la siguiente división $34,95:3,1$ obteniendo dos decimales.
    %     \vspace{\stretch{1}} 
    ...
    \question[2] Realiza las siguientes operaciones con fracciones, simplificando el resultado al máximo:
        \begin {parts}
            \part $\frac{7}{3} + \frac{2}{5} + \frac{5}{7}$
            \vspace{\stretch{2}}
            
            \part $1 - \frac{3}{5} \cdot \frac{1}{2}$
            \vspace{\stretch{2}}

            \part $\frac{2}{7} : \frac{5}{3}$
            \vspace{\stretch{2}}
        \end{parts} 

    \question[2]Realiza las siguientes operaciones con fracciones, simplificando el resultado al máximo:
        \begin {parts}
            \part $\left(\frac{5}{3} - \frac{1}{4}\right) : \left(1 - \frac{2}{5}\right)$
            \vspace{\stretch{3}}
            
            \part $\frac{10}{7} \cdot \frac{21}{4} \cdot \frac{2}{3} $
            \vspace{\stretch{3}}
        \end{parts} 

    \newpage
    \question[1] Entre tres hermanos deben repartirse 120 \euro. 
    El primero se lleva $\frac{7}{13}$ del total, el segundo $\frac{5}{14}$ del total y el tercero el resto.
    \begin {parts}
    ...
    \question[1] Manuel compra 3 kg de peras a 2,45\euro{} el kg y paga con un billete de 20 €.
    \begin {parts}
        \part ¿Cuánto dinero se gasta?
        \vspace{\stretch{1}}
        \part ¿Cuánto le tienen que devolver? Redondea a dos décima.
        \vspace{\stretch{1}}
    \end{parts} 


    \question[1] Un obrero gana 380 \euro{} a la semana. 
    ¿Cuánto gana en 54 días?
    \vspace{\stretch{1}}
    ...
    \question[1] Una perfumería vende en una semana 53 frascos de una misma colonia. 
    Cada frasco lo vende a un precio de 78,35 \euro. 
    ...
    \\
    $3,05$ \phantom{1234} $5,101$ \phantom{1234} $5,11$ \phantom{1234} $5,005$ \phantom{1234} $5,1$ \phantom{1234} $3$
    \vspace{\stretch{1}}
    
    \question[0\half] Obtén dos números decimales que estén comprendidos entre 3,6 y 3,7, uno que tenga dos decimales y otro que tenga tres.
    \vspace{\stretch{1}}
