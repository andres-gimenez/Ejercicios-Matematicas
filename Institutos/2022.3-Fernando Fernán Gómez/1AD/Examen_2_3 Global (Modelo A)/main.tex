...
\end{center}
 ...
 \begin{questions}
    ...
    \question
    \begin {parts}
        \part[1] Realiza las siguientes operaciones con números decimales:
        \begin {subparts}
            \subpart $2,003 + 24,69 + 525,7$
            \vspace{\stretch{1}}

            \subpart $32,95 - 9,871$
            \vspace{\stretch{1}}

            \subpart $(5,2 - 6) \cdot 6$
            \vspace{\stretch{1}}
        \end{subparts} 
        
        \part Divisiones 
        \begin {subparts}
            \subpart [0\half] Realiza la siguiente división $34,95:3,1$ obteniendo dos decimales.
            \vspace{\stretch{2}} 

            \subpart [0\half] Haz la prueba de la división anterior.
            \vspace{\stretch{2}}
        \end{subparts} 
    \end{parts} 
    ...
    \question
    \begin {parts} 
        \part[1] Realiza las siguientes operaciones con fracciones, simplificando el resultado al máximo:
        \begin {subparts}
            \subpart $\frac{2}{3} + \frac{5}{9} + \frac{2}{4}$
            \vspace{\stretch{1}}
            
            \subpart $1 - \frac{2}{3} \cdot \frac{1}{5}$
            \vspace{\stretch{1}}

            \subpart $\frac{2}{5}: \frac{2}{3}$
            \vspace{\stretch{1}}
        \end{subparts} 

        \part[1]Realiza las siguientes operaciones con fracciones, simplificando el resultado al máximo:
            \begin {subparts}
                \subpart $\left(\frac{5}{4} - \frac{2}{3}\right) : \left(1 - \frac{4}{6}\right)$
                \vspace{\stretch{1}}
                
                \subpart $\frac{10}{7} \cdot \frac{21}{4} \cdot \frac{2}{5} $
                \vspace{\stretch{1}}
            \end{subparts} 
        \end{parts} 
