...
\end{center}
 ...
 \begin{questions}
    ...
    \question[1] En una zapatería ves unos zapatos que cuestan 65\euro rebajados un 15\%, ¿Cuánto cuestan los zapatos?
    \vspace{\stretch{1}}

    \question[1\half] Tres obreros realizan un trabajo en 5 horas. ¿En cuánto tiempo realizarán dos obreros el mismo trabajo? 4
    \vspace{\stretch{2}}
