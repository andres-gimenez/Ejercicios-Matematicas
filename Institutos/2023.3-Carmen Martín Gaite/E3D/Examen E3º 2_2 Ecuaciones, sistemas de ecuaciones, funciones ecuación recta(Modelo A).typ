...
#g-question(point: 2)[Obtén la ecuación de la recta que pasa por los puntos $A(4,5)$ y $B(2,6)$
    expresándola en su forma general y explicita.]
#v(1fr)

#g-question(point: 2)[Indica cuál de los siguientes puntos $A(3, -4)$, $B(2, 7)$, $C(-3, 6)$, $D(1/5, 2/3)$ 
...
#g-question(point: 2)[Dada la recta $2x-3y+3=0$ indica cuál es su pendiente y el punto de corte con los ejes.]
#v(1fr)
...
#g-question(point: 2)[Manuel trabaja como repartidor los fines de semana y recibe una cantidad fija de 40€ mensuales, 
    ...
    #g-subquestion[¿Cuántos paquetes tiene que repartir Manuel para cobrar en un mes 152€?]
  ]
