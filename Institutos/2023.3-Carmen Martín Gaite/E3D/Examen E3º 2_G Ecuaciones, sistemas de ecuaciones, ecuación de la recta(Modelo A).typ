...
#g-question[Obtén la ecuación de la recta que pasa por los puntos $A(4,5)$ y $B(2,6)$ expresándola en su forma
general y explicita]

#g-question[Obtén la ecuación de la recta que pasa por los puntos $A(5,4)$ y $B(6,2)$ expresándola en su forma
general y explicita]

#g-question[Calcula la ecuación de la recta paralela a $x - 2y - 2 = 0$ y que pase por el punto $P(1,2)$. 
