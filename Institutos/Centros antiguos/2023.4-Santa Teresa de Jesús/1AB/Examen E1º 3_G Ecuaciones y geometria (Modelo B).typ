...
#g-question(point:2)[En un rectángulo en el que la base mide 12cm y la altura 9cm, ¿cuánto mide la diagonal?] \
...
#cetz.canvas(length: 2cm,
{
 import cetz.draw: *
  ...
  content((0.5, -1.2), [base = 12 cm])
  content((2.2, 0), [altura = 9 cm], angle:90deg)
