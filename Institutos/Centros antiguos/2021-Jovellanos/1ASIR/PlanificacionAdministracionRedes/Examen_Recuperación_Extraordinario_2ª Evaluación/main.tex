%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\documentName} { Examen extraordinario }
\newcommand{\documentContent} { 2ª evaluación } 
\newcommand{\waterMark} { } 
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{questions}
    ...
    \begin{parts}
        ...
        \PartNoBreak{ 
            En la configuración IP de un HOST los parámetros que intervienen en el enrutamiento de los paquetes son \dots
            \newline
            \begin{oneparcheckboxes}
                \choice
                \dots IP, mascara y puerta de enlace.
                \newline
                \CorrectChoice
                \dots IP y puerta de enlace.
                \newline
                \choice
                \dots IP, MAC, mascara y puerta de enlace.
                \newline
            \end{oneparcheckboxes}
        }
    ...
    \question[4] En un instituto se quiere ampliar el sistema informático y te han pedido que reconfigures los dispositivos de red para dar soporte a los nuevos equipos.
    ...
    \question[2] Explica haciendo referencia al ejercicio anterior, 
    el funcionamiento y finalidad de los protocolos IP, NAT, DHCP y DNS.
    Haciendo referencia a parámetros de configuración de cada protocolo y mecanismos de enrutamiento.
