...
\begin{questions}
    ...
    Los routers que nos ha proporcionado el ISP ya están preconfigurados con las IP’s públicas y fijas 83.26.36.45/24 (R1) y 72.26.89.80/24 (R2) y en ambos IP privada 192.168.0.0/24. 
    ...
    \\ \\
    \footnotesize{(*) Se valorará en función de los conocimientos demostrados en la configuración de una Red LAN y WAN con IP's privadas y públicas, enrutamiento, NAT, DHCP y DNS. }
    \\ 
