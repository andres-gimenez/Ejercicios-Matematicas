...
\newcommand{\documentContent} { 3ª evaluación } 
\newcommand{\waterMark} { } 
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{questions}
    ...
    \begin{parts}
        \part[3]
            ...
            \\
            \footnotesize{(*)Se está pidiendo exclusivamente configuración de cada dispositivo, si la necesita. Direcciones IP's, mascaras, puerta de enlace, ...}
            \normalsize{}
            \newpage
            \phantom{new page}
            \newpage
