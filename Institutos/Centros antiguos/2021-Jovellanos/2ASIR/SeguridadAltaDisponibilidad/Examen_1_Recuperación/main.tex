...
\begin{questions}
    ...
    \QuestionNoBreak{}
    El código pin de una tarjeta inteligente (o smart card)  \dots
    \newline
    \nolinebreak{
        \begin{oneparcheckboxes}
            \CorrectChoice{}
    ...
    \QuestionNoBreak{}
    Los armarios o Rack, están destinados al almacenar electrónico, informático y de comunicaciones. 
    ...
    \nolinebreak{
        \begin{oneparcheckboxes}
            ...
            \newline
            \choice
            \dots al dispositivo, ya que la persona necesita un dispositivo electrónico para acceder a un sistema informático.
            \newline
            \CorrectChoice
    ...
    \nolinebreak{
        \begin{oneparcheckboxes}
            ...
            \newline
            \choice{}
            \dots un concentrado de comunicaciones VoIP.
            \newline
        \end{oneparcheckboxes}
    }
