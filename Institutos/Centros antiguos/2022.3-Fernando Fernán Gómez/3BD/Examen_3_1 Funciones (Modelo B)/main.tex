...
\renewcommand{\documentContent} { Funciones lineales y cuadráticas } 
...
\begin{questions}
    ...
    \question[2] Indica cuál de los siguientes puntos $A \left(-4, 3\right)$, $B\left(7, 2\right)$, $C\left(6, -3\right)$, $D\left(\frac{2}{3}, \frac{1}{5}\right)$ 
    ...
    \question[2] Dada la recta $3x-2y+3 = 0$ indica cuál es su pendiente y el punto de corte con los ejes.
    \vspace{\stretch{1}}
    ...
    \newpage
    \question[2] Manuel trabaja como repartidor los fines de semana y recibe una cantidad fija de 80\euro{} mensuales, 
    ...
    \begin{parts}
        ...
        \begin{figure}[h]
            ...
            \end{center}
        \end{figure}
            \part ¿Cuántos paquetes tiene que repartir Manuel para cobrar en un mes 176\euro{}?
            \\
