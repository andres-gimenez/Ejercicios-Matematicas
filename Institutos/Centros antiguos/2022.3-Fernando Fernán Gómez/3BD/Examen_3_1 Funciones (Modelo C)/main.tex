...
\renewcommand{\waterMark} { Modelo C } 
...
\begin{questions}
    ...
    \question[2] Calcula la ecuación de la recta paralela (tiene la misma pendiente) a $y=5x+2$ y que pase por el punto $(0, 5)$.
    \\
    ...
    más 8\euro{} por cada paquete que reparte.
    \begin{parts}
