\documentclass[addpoints,spanish, 12pt,a4paper,cancelspace]{./include/gexam}
 ...
 \renewcommand{\documentContent} { Fracciones y proporcionalidad } 
 ...
 \begin{questions}
    \question[3] Realiza las siguientes operaciones con fracciones y simplifica el resultado lo máximo posible:
        ...
        \begin {parts}
            \part $\frac{1}{3} + \frac{3}{10} - \frac{7}{5}$
            \vspace{\stretch{2}}

            \part $\frac{5}{3} \cdot \left(\frac{6}{10} + \frac{9}{15}\right)$
            \vspace{\stretch{2}}

            \part $\frac{2}{3} : \left(\frac{1}{6} + \frac{1}{3}\right)$
            \vspace{\stretch{2}}

            \newpage{}

            \part $\left(\frac{5}{7} \right)^4 \cdot \left(\frac{5}{7} \right)^3 $
            \vspace{\stretch{1}}

            \part $\left(\frac{3}{5} \right)^7 : \left[\left(\frac{3}{5} \right)^3\right]^2 $
            \vspace{\stretch{1}}

            \part $\sqrt{\frac{25}{16}}$
            \vspace{\stretch{1}}
        \end{parts}
    ...
    \question[2] El precio de 11 bolígrafos es de 2,50\euro{}. ¿Cuánto costarán 32 bolígrafos?
    \\
    (*) Se ha de resolver el problema mediante una regla de tres.
    \vspace{\stretch{1}}
    
    \question[2] Diez yogures de fresa cuestan 2,10\euro{}. ¿Cuánto costarán 18 yogures? ¿Y 24 yogures? 
    \\
    (*) Se ha de resolver el problema mediante una regla de tres.
    \vspace{\stretch{1}}
