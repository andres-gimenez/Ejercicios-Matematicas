\documentclass[addpoints,spanish, 12pt,a4paper,cancelspace]{./include/gexam}
 ...
 \renewcommand{\documentContent} { 3ª evaluación } 
...
\end{center}
 ...
 \begin{questions}
    ...
    \question[2] Completa la tabla de los múltiplos y submúltiplos de las unidades de capacidad:
    \\
    \begin{center}
    % \begin{table}[]
        \begin{tabular}{|l|l|l|l|}
        \hline
        \multirow{4}{*}{Múltiplos}             & Mirialitro & \multicolumn{1}{r|}{Mag} & \multicolumn{1}{r|}{10.000 g} \\ \cline{2-4} 
                                               &            &     &          \\ \cline{2-4} 
                                               &            &     &          \\ \cline{2-4} 
                                               &            &     &          \\ \hline
        \multicolumn{1}{|r|}{Unidad principal} & litro      & \multicolumn{1}{r|}{g} &  \multicolumn{1}{r|}{1 g} \\ \hline
