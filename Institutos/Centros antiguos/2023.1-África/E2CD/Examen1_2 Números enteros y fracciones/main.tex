...
\begin{questions}
    ...
    \begin{parts}
        ...
        \part $\left(2+6\right) - 2 \cdot \left(2+7\right) + 5 \cdot \left(3 - 2\right) =$
        \vspace{\stretch{1}}
    \end{parts}
    \newpage 
    ...
    \question[2] Resuelve y simplifica el resultado.
    \begin{parts}
    ...
    \begin{parts}
        ...
        \part $\frac{15}{18} + \left( \frac{3}{2} - \frac{1}{4} \right)^2 = $
        \vspace{\stretch{1}}
    \end{parts}

    \question[2] Resuelve la siguiente expresión
    \begin{parts}
        \part $\left(5 - 2\right)^2 + 3^2 \cdot 25 - 7\cdot \left(9 - 2\right)= $ 
        \vspace{\stretch{1}}
