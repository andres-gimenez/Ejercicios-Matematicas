...
\begin{questions}
    ...
    \question[2] En dos años el precio de un producto se ha quintuplicado. 
    ...
    queremos que se paguen 50\euro{} por entrada en la taquilla. 
    ¿Cuál será el precio real de la entrada? 
    ¿Cuánto será el importe del IVA, teniendo en cuenta que primero se aplica el descuento y luego se aplica el IVA? 
    \newpage 

    \question[3] Calcula el capital final que se obtiene al depositar 6.500\euro{} en una entidad bancaria al 6\% anual durante 9 años, 
    ...
    \question[3] ¿Cuál es el mínimo tiempo que hay que depositar 7.000\euro{} al 6\% anual, con periodo de capitalización trimestral, 
    para que se conviertan en más de 9.000\euro{}?
