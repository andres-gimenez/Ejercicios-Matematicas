...
\begin{questions}
    ...
    \question[2] Racionaliza las siguientes expresiones:
        \begin{parts}
            \part $\frac{2\sqrt{3}}{\sqrt{2}-\sqrt{3}}$
            \vspace{\stretch{1}}

            \part $\frac{\sqrt{3}}{\sqrt{5}}$
            \vspace{\stretch{1}}

            \part $\frac{2+\sqrt{16}}{\sqrt{36}}$
            \vspace{\stretch{1}}

            \part $\frac{\sqrt{504.000}}{\sqrt{60.984}}$
            \vspace{\stretch{1}}
        \end{parts}
    \newpage 
    ...
    \question[3] Halla el valor de x en estas expresiones aplicando las propiedades de los logaritmos:
        \begin{parts}
            \part $\log_5{x} = \log_5 125 + \log_5 5$   
            \vspace{\stretch{1}}

            \part $\ln{x} = \ln{3} + \ln{4} - \ln{12}$
            \vspace{\stretch{1}}

            % \part $\log{x} = \log{25} - \log{5}$
            % \vspace{\stretch{1}}

            \part $\log{x} = 2\log{3} - \frac{1}{2} \log{16}$
            \vspace{\stretch{1}}
    ...
    \question[3] Resuelve las siguientes ecuaciones
        \begin{parts}
            ...
            % \part $3^{2x-3} = 8^{x+1}$
            % \part $3^{x+2} = 810 - 3^{2x+2} $
            \part $3^{x+1} = 270 - 3^{2x+1} $
            \vspace{\stretch{1}}
            % \part $2^{x-3} = -3$
