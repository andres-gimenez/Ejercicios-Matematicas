...
#question(points:2)[En el estuche, tenemos 3 bolígrafos azules, 2 negros, 4 rojos y 1 verde. Si sacamos un bolígrafo al azar, para hacer el examen, que probabilidad hay de que:]
...
#subquestion(points:2)[$display(3 dot (4-3) + (3^2 - 5)^2 dot  (2-7))$=]
#v(1fr)
