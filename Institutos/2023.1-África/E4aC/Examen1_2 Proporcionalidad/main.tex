...
\begin{questions}
    ...
    \newpage 
    \question[2] Descompón el valor numérico en factores primos para posteriormente calcula el valor de los siguientes logaritmos. \\
    ...
    \question[2] Expresa las siguientes expresiones como un solo logaritmo: \\ 
    (*La solución hay que expresarla como el logaritmo de una expresión numérica, sin necesidad de dar un número como solución.)

    \begin{parts}
        \part $\log_5 8 + 2 \log_5 7 - \log_5 400$
        \vspace{\stretch{1}}

        \part $\log_7 9 - 3 \log_7 5 + \log_7 3$
        \vspace{\stretch{1}}
