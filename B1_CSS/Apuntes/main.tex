...
\title{Matemáticas aplicadas a las ciencias sociales}
\author{Andrés Giménez Muñoz\\
  % \small IES \\
  \small agimenezmunoz@educa.madrid.org\\
...
\subsection{Aumento y disminuciones porcentuales. Índice y tasa de variación}
...
\subsubsection{Anualidades de capitalización}

\subsubsection{Anualidades de amortización}

\subsection{Números índice}

\subsection{Parámetros económicos y sociales}

\subsubsection{Tasa anual equivalente (TAE)}

\subsubsection{Números índice}

\section{Ecuaciones y sistemas de ecuaciones}

\section{Inecuaciones y sistema de inecuaciones}

\section{Funciones reales de variable real}

\section{Límites de funciones. Continuidad}

\section {Derivada de una función}

\section{Estudio y representación de funciones}

\section{Estadística}

\section{Probabilidad}

\section{Distribuciones discretas y continuidad. Distribución binomial y normal}
